...
export default function CreateStorePage() {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const message =
                err instanceof Error ? err.message : 'Không thể tạo kho hàng';
            setError(message);
        } finally {
            setLoading(false);
        }
            ...
            <main className="ml-[264px] mt-6 p-6 pr-12">
                <div className="mb-4">
                    <p className="text-base font-bold text-gray-800">
                        Danh mục &gt; Kho hàng &gt; Thêm kho hàng
                    </p>
                </div>
                    ...
                    >
                        <div className="grid grid-cols-3 gap-4 items-center">
                            ...
                            <input
                                ...
                                placeholder="Ví dụ: Kho tổng, Kho Hà Nội..."
                                value={name}
                        ...
                        <div className="grid grid-cols-3 gap-4 items-start">
                            ...
                            <textarea
                                ...
                                placeholder="Ghi chú thêm cho kho hàng"
                                value={description}
