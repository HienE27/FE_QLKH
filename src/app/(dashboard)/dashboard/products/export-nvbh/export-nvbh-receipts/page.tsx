...
import { getStaffExports, type StaffExport, type ExportStatus } from '@/services/inventory.service';
...
export default function PhieuXuatNhanVien() {
    const router = useRouter();
    const [data, setData] = useState<StaffExport[]>([]);
    ...
    const loadExports = async () => {
        try {
            setLoading(true);
            setError(null);
            const exports: StaffExport[] = await getStaffExports({
            ...
            const filtered = staffFilter === 'ALL'
                ? exports
                : exports.filter(ex => ex.staffId === staffFilter);
            ...
            if (err instanceof Error) {
                ...
                setError('Lỗi tải danh sách phiếu xuất nhân viên');
            }
            console.error(err);
        } finally {
            setLoading(false);
            ...
            <main className="ml-[377px] mt-[113px] p-6 pr-12">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <button
                            onClick={() => router.push('/dashboard/products/export-nvbh/create-export-nvbh-receipt')}
                                ...
                                {data.length === 0 ? (
                                    ...
                                    currentData.map((record, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 text-center text-sm">
                                                {staffMap.get(record.staffId) || record.staffName || `Nhân viên #${record.staffId}`}
                                            </td>
                                            <td className="px-4 text-center text-sm">
                                                    ...
                                                    <button
                                                        onClick={() => {
                                                            if (
                                                                ...
                                                                router.push(
                                                                    `/dashboard/products/export-nvbh/edit-export-nvbh-receipt/${record.id}`,
                                                                );
                                                            }
                                                        }}
                                                        disabled={
