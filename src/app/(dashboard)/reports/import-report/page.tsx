...
export default function ImportReportPage() {
    ...
    const importedCount = useMemo(
        () => filteredData.filter((record) => record.status === 'IMPORTED').length,
        [filteredData],
    );
                        ...
                        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                            <div className="bg-white rounded-lg shadow-sm border border-blue-gray-200 p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm text-blue-gray-600">Tổng phiếu nhập</p>
                            ...
                            <div className="bg-white rounded-lg shadow-sm border border-blue-gray-200 p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm text-blue-gray-600">Đã nhập kho</p>
                                        <p className="text-2xl font-bold text-green-600 mt-1">{importedCount}</p>
                                    </div>
